...
var latinStrokeFont = {
	...
	"9":{w:5,s:[[1,0,4,0],[4,0,5,1],[5,1,5,3.5],[5,3.5,4,4.5],[4,4.5,1,4.5],[1,4.5,0,3.5],[0,3.5,0,1],[0,1,1,0],[5,3.5,5,6],[5,6,4,7],[4,7,1,7],[1,7,0.4,6.5]]},
	"-":{w:4,s:[[0,3.5,4,3.5]]},
	".":{w:2,s:[[1,6.6,1,7]]},
	",":{w:2,s:[[1,6.5,0.4,7.7]]},
...
function latinStrokeSegment(x1, y1, x2, y2, scale, xOffset, yTop)
{
	...
	// Usa o mesmo método do símbolo NFC: segmento retangular + tampas cilíndricas.
	// Isso arredonda as extremidades dos traços e reduz o efeito serrilhado/vértices
	// quando a espessura do texto latino é aumentada.
	return raisedStrokeSegment(sx1, sy1, sx2, sy2, parameters.latin_height, parameters.latin_stroke_width, parameters.resolution);
}
...
function getParameterDefinitions()
{
	...
	var parameterDefinitions = [
		...
		{ name: 'dot_height', caption: 'Altura do ponto [padrão: 0.75mm]:', type: 'range', initial: 0.75, begin: 0.6, end: 0.8, step: 0.01 },
		{ name: 'dot_diameter', caption: 'Diâmetro do ponto [padrão: 1.9mm]:', type: 'range', initial: 1.9, begin: 1.2, end: 2.0, step: 0.01 },
